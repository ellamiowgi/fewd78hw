...
*/
		...
		value: function onResize(e) {
			this.element.width = this.$parentElement.outerWidth();
			this.element.height = this.$parentElement.outerHeight();
		...
		value: function onMouseMove(e) {
			...
			this.mouseY = e.clientY + window.scrollY - 56;
			return this;
		}
		...
		value: function setScene() {
			...
			this.gradient.addColorStop(0, '#283048'); // 
			this.gradient.addColorStop(0.25, '#424a62'); // 
			// this.gradient.addColorStop(1, '#a84a68'); // reddish
			this.gradient.addColorStop(1, '#859398'); //  
